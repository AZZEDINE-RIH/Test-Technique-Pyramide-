...
$email = 'test_post_' . time() . '@example.com';
...
$projectData = [
    'title' => 'Projet de test POST',
    'description' => 'Description du projet de test POST'
];
...
// 3. Mise à jour du projet via la route POST
echo "\n3. Mise à jour du projet via la route POST\n";

$updateData = [
    'title' => 'Projet de test POST mis à jour',
...
if ($updateProjectResult['code'] >= 200 && $updateProjectResult['code'] < 300) {
    echo "\n✅ Projet mis à jour avec succès via POST!\n";
} else {
    echo "\n❌ Échec de la mise à jour du projet via POST.\n";
    exit(1);
}
...
echo "\n🎉 TEST DE MISE À JOUR VIA POST TERMINÉ AVEC SUCCÈS!\n";